...
#include <memory>
#include "../remotecontrol/graphviewer.h"
...
QT_INIT_METAOBJECT const QMetaObject GraphViewer::staticMetaObject = { {
    QMetaObject::SuperData::link<QChartView::staticMetaObject>(),
    qt_meta_stringdata_GraphViewer.data,
    qt_meta_data_GraphViewer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
